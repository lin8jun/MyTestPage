...
System.register("chunks:///_virtual/DepositPage.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './GloTabBtn.ts', './Constant.ts', './Decorators.ts', './NGame.ts', './GameDataMgr.ts', './WebApiEnums.ts', './PayUtils.ts', './DepositInfo.ts', './FirstDepositLittle.ts', './WidFirst.ts', './WidInfo.ts', './BaseTabPage.ts', './GoogleAnatytics.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, GloTabBtn, TabEvent, EventName, inject, NGame, gameDataMgr, pbfixActivityJoinStatus, PayUtils, DepositInfo, FirstDepositLittle, WidFirst, WidInfo, BaseTabPage, GoogleAnalytics, GAEvent;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
...
System.register("chunks:///_virtual/FreeBonusWithdraw.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './GloTitleBar.ts', './Constant.ts', './Decorators.ts', './UIHelper.ts', './MKViewBase.ts', './NGame.ts', './GameDataMgr.ts', './UIController.ts', './HttpPbFunc.ts', './WebApiEnums.ts', './GoogleAnatytics.ts', './Utils.ts', './PayTypeItem.ts', './CantWithdrawToRecharge.ts', './NeedMorePlay.ts', './WidAccountInfoView.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, Node, instantiate, EditBox, v3, tween, GloTitleBar, EventName, BundleName, inject, UIHelper, UIPath, MKViewBase, NGame, gameDataMgr, UIController, HttpPbFunc, isResponseValid, pbfixMoneyType, GoogleAnalytics, GAEvent, Utils, safetyNum, PayTypeItem, CantWithdrawToRecharge, NeedMorePlay, WidAccountInfoView;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var FreeBonusWithdraw = exports('FreeBonusWithdraw', (_dec = ccclass('FreeBonusWithdraw'), _dec2 = inject("contractTypesNode", Node), _dec3 = inject("GloTitleBar", GloTitleBar), _dec4 = inject("ScrollView/view/content/Bottom1/WidAccountInfoView", Node), _dec5 = inject("ScrollView/view/content/Bottom2/WidAccountInfoView", Node), _dec6 = inject("ScrollView/view/content/Bottom1/widItemParent1", Node), _dec7 = inject("ScrollView/view/content/Bottom2/widItemParent2", Node), _dec8 = inject("ScrollView/view/content/RewardScroller", Node), _dec9 = inject("PayTypeItem", Node), _dec(_class = (_class2 = /*#__PURE__*/function (_MKViewBase) {
        ...
        function FreeBonusWithdraw() {
          ...
          _this = _MKViewBase.call.apply(_MKViewBase, [this].concat(args)) || this;
          _initializerDefineProperty(_this, "contractTypesNode", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "gloTitleBar", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "widAccountInfoView1", _descriptor3, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "widAccountInfoView2", _descriptor4, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "widItemParent1", _descriptor5, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "widItemParent2", _descriptor6, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "rewardScroller", _descriptor7, _assertThisInitialized(_this));
          // 奖励轮播
        ...
        _proto.open = function open() {
          ...
          this.onClicked(this.contractTypesNode, this.closeContractTypesList.bind(this), true, 0.1, false);
          ...
          // if (!UserDate.getInstance().rechargeList) {
          //     ServerManager.getInstance().rechargeList(() => {
          //         this.swicthTag();
          //     })
          // } else {

          // this.widAccountInfoView1.getComponent(WidAccountInfoView).setInfoValidCallback((isValid: boolean) => {
          //     this.allNode.WithdrawlBtn.getComponent(Button).interactable = isValid;
          // })
          // this.widAccountInfoView2.getComponent(WidAccountInfoView).setInfoValidCallback((isValid: boolean) => {
          //     this.allNode.WithdrawlBtn2.getComponent(Button).interactable = isValid;
          // })
        ...
        _proto.swicthTag = function swicthTag() {
          ...
          if (this.userInfo.pbfixBalance == 0) {
            ...
            // this.allNode.emailEditBox.on('text-changed', this.onTextChanged, this);
            // this.allNode.addressEditBox.on('text-changed', this.onTextChanged, this);
            ...
            // this.allNode.emailEditBox2.on('text-changed', this.onTextChanged2, this);
            // this.allNode.addressEditBox2.on('text-changed', this.onTextChanged2, this);
        ...
        _proto.updataWithdrawUi = function updataWithdrawUi() {
          ...
          // if (this.allNode.Toplistcontent2DDD.children.length == 0) {
          //     this.allNode.Toplistcontent2DDD.removeAllChildren()
          //     for (let index = 0; index < this.walletList.length; index++) {
          //         let item = instantiate(this.allNode.walletItemBase2)
          //         let data = this.walletList[index]
          //         item.active = true
          //         item.parent = this.allNode.Toplistcontent2DDD
          //         item.setPosition(0, 0)
          //         item.child("name").setText(data.pbfixName)
          //         this.setWItemState(item, this.curWithdrawTypeIdx == index)
          //         item.child("ic").loadUrlImg(
          //             {
          //                 url: data.pbfixIconUrl,
          //                 target: this.node
          //             }
          //         )
          ...
          //         this.onClicked(item, () => {
          //             // this.tag = tt;
          //             this.curWithdrawTypeIdx = index;
          //             this.curChannelIdx = 0;
          //             this.updataWithdrawUi();
          //         });
          //     }

          //     // this.allNode.ScrollViewDDD.getComponent(ScrollView).scrollToPercentHorizontal(this.tag / walletList.length, 0.3, true)
          // } else {
          //     for (let index = 0; index < this.allNode.Toplistcontent2DDD.children.length; index++) {
          //         const item = this.allNode.Toplistcontent2DDD.children[index];
          //         // let tt = index + 1
          //         this.setWItemState(item, this.curWithdrawTypeIdx == index)
          //     }
          // }
          ...
          // this.allNode.LimitNum.setText("Min Bonus Balance".i18nStr() + ":" + Utils.changeMoneyUnit(limitMoney, 1))
          this.allNode.label_layout.child('LimitNum').setText(Utils.changeMoneyUnit(limitMoney, 1));

          // this.onClicked(this.allNode.MaxBtn, () => {
          //     let maxMoney = Math.min(limitMoney, UserDate.getInstance().userProfile.bonus)
          //     this.allNode.numEditBox.getComponent(EditBox).string = maxMoney + ""
          // });
          ...
          // this.allNode.FeeLb.getComponent(Label).string = window.getLocalizedStr("Fee Rate") + ":" + UserDate.getInstance().gameConfig.other_conf.withdraw_activity_usdt_fee + "%"
          // this._curTag = this.tag
          // this.onTextChanged2();
        ...
        _proto.updataGuideRechargeUi = function updataGuideRechargeUi() {
          ...
          // if (this.allNode.Toplistcontent.children.length == 0) {
          //     this.allNode.Toplistcontent.removeAllChildren()
          //     for (let index = 0; index < this.walletList.length; index++) {
          //         let item = instantiate(this.allNode.walletItemBtn)
          //         let data = this.walletList[index]
          //         item.active = true
          //         item.parent = this.allNode.Toplistcontent
          //         item.child("name").setText(data.pbfixName)
          //         this.setWItemState(item, this.curWithdrawTypeIdx == index)
          //         item.child("ic").loadUrlImg(
          //             {
          ...
          // } else {
          //     for (let index = 0; index < this.allNode.Toplistcontent.children.length; index++) {
          //         const item = this.allNode.Toplistcontent.children[index];
          //         let tt = index + 1
          //         this.setWItemState(item, this.curWithdrawTypeIdx == index)
          //     }
          // }
        ...
        _proto.updateWalletByGuide = function updateWalletByGuide() {
          ...
          // this.allNode.CashNode.active = !info.pbfixIsWallet
          this.allNode.usdtNode.active = info.pbfixIsWallet;
          // this.allNode.emilTag.setText(`Account E-Mail`.i18nStr([info.pbfixName]))
          this.allNode.emailEditBox.getComponent(EditBox).string = "";
          this.allNode.addressEditBox.getComponent(EditBox).string = "";
          // this.allNode.WithdrawlBtn.getComponent(Button).interactable = false
          this.curContractType = info.pbfixContractTypes[0];
          this.updateCurContractType();
          this.initContractTypesList(info.pbfixContractTypes);
          // this.allNode.emailEditBox.getComponent(EditBox).placeholder = "Enter Account E-Mail".i18nStr([info.pbfixName])

          var b1 = this.allNode.usdtNode2.child("b1");
          b1.child("xl").active = info.pbfixContractTypes.length > 1;
          if (info.pbfixContractTypes.length > 1) {
            this.onClicked(b1, this.openContractTypesList.bind(this), true, 0.1, false);
          } else {
            this.offClicked(b1);
          }
        ...
        _proto.updateWalletByReal = function updateWalletByReal() {
          var info = this.walletList[this.curWithdrawTypeIdx].pbfixChannelList[this.curChannelIdx];
          // this.allNode.CashNode2.active = !info.pbfixIsWallet
          this.allNode.usdtNode2.active = info.pbfixIsWallet;
          // this.allNode.emilTag2.setText(`Account E-Mail`.i18nStr([info.pbfixName]))
          this.allNode.addressEditBox2.getComponent(EditBox).string = "";
          // this.allNode.WithdrawlBtn2.getComponent(Button).interactable = false
          this.curContractType = info.pbfixContractTypes[0];
          this.updateCurContractType();
          this.initContractTypesList(info.pbfixContractTypes);
        ...
        _proto.updateCurContractType = function updateCurContractType() {
          (this.curIsGuideRecharge ? this.allNode.ghghgh : this.allNode.ghghgh2).setText(this.curContractType);
        }

        // onTextChanged() {
        //     if (this.walletList.length == 0) return
        //     let info = this.walletList[this.curWithdrawTypeIdx].pbfixChannelList[this.curChannelIdx]
        //     if (info.pbfixIsWallet) {
        //         let adress = this.allNode.addressEditBox.getComponent(EditBox).string
        //         this.allNode.WithdrawlBtn.getComponent(Button).interactable = adress.length > 0
        //     } else {
        //         let eMailStr = this.allNode.emailEditBox.getComponent(EditBox).string
        //         this.allNode.WithdrawlBtn.getComponent(Button).interactable = eMailStr.length > 0 && Utils.isValidEmail(eMailStr)
        //     }
        // }
        ...
        //     let info = this.walletList[this.curWithdrawTypeIdx].pbfixChannelList[this.curChannelIdx]
        //     if (info.pbfixIsWallet) {
        //         let adress = this.allNode.addressEditBox2.getComponent(EditBox).string
        //         this.allNode.WithdrawlBtn2.getComponent(Button).interactable = adress.length > 0
        //     } else {
        //         let eMailStr = this.allNode.emailEditBox2.getComponent(EditBox).string
        //         this.allNode.WithdrawlBtn2.getComponent(Button).interactable = eMailStr.length > 0 && Utils.isValidEmail(eMailStr)
        //     }
        // }
        ...
        _proto.toWithdrawl = function toWithdrawl() {
          ...
          if (proValue > 0) {
            NGame.tips.toast("Bet no enough".i18nStr());
            return;
          }
          var min_bonus = gameDataMgr.hallConf.pbfixBonusWMinBalance;
          var bonus = this.userInfo.pbfixBonus;
          ...
          var walletAddress = "";
          if (info.pbfixIsWallet) {
            walletAddress = this.allNode.addressEditBox2.getComponent(EditBox).string;
            // withdrawTypeId = this.curContractType
          }

          this.isReqWidIng = true;
          HttpPbFunc.pbfixWithdrawReq(this.node, moneyType, amount, info.pbfixTypeId, info.pbfixChannelId, this.widAccountInfoView2.getComponent(WidAccountInfoView).getWithdrawInfoJson(), walletAddress, function (result) {
        ...
        _proto.setWItemState = function setWItemState(imageNode, isChecked) {
          imageNode.loadImg("common/img/" + (isChecked ? "bg_pay_item_sel" : "bg_pay_item"), BundleName.DEFAULT);
        };
        _proto.initContractTypesList = function initContractTypesList(types) {
          var _this7 = this;
          this.contractTypesNode.child("typeList").removeAllChildren();
          types.forEach(function (type, index) {
            var typeItem = instantiate(_this7.contractTypesNode.child("typeItem"));
            typeItem.active = true;
            typeItem.setText(type);
            _this7.contractTypesNode.child("typeList").addChild(typeItem);
            _this7.onClicked(typeItem, function () {
              _this7.closeContractTypesList();
              _this7.curContractType = type;
              _this7.updateCurContractType();
            });
          });
        };
        _proto.openContractTypesList = function openContractTypesList() {
          var target = this.curIsGuideRecharge ? this.allNode.usdtNode.child("b1") : this.allNode.usdtNode.child("b1");
          this.contractTypesNode.active = true;
          this.contractTypesNode.child("typeList").worldPosition = target.worldPosition.clone().add(v3(0, -40));
          tween(this.contractTypesNode.child("typeList")).to(0.1, {
            scale: v3(1, 1, 1)
          }).bindNodeState(false).start();
        };
        _proto.closeContractTypesList = function closeContractTypesList() {
          var _this8 = this;
          tween(this.contractTypesNode.child("typeList")).to(0.1, {
            scale: v3(1, 0, 1)
          }).bindNodeState(false).call(function () {
            _this8.contractTypesNode.active = false;
          }).start();
        };
      ...
      }(MKViewBase), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "contractTypesNode", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "gloTitleBar", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "widAccountInfoView1", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "widAccountInfoView2", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "widItemParent1", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "widItemParent2", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "rewardScroller", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
    ...
    execute: function () {
      ...
      var GameBaseItem = exports('GameBaseItem', (_dec = ccclass('GameBaseItem'), _dec2 = inject("ic", Node), _dec3 = inject("gameName", Node), _dec4 = inject("HearNode", Node), _dec5 = inject("costBtns", Node), _dec6 = inject("tag_new", Node), _dec7 = inject("tag_hot", Node), _dec(_class = (_class2 = (_class3 = /*#__PURE__*/function (_MKStaticViewBase) {
        ...
        _proto.onLoad = function onLoad() {
          ...
          this.checkNodeClickValid(this.icon, function (isValidClick, e) {
            if (isValidClick) {
        ...
        _proto.onClickGameItem = function onClickGameItem() {
          var _this5 = this;
          GoogleAnalytics.track(GAEvent.CLICK_GAME_ICON);
        ...
        _proto.onClickLoveBtn = function onClickLoveBtn() {
          ...
          if (this.isLoved) {
            GoogleAnalytics.track(GAEvent.CLICK_GAME_LOVE_CANCEL);
          } else {
            GoogleAnalytics.track(GAEvent.CLICK_GAME_LOVE);
          }
...
System.register("chunks:///_virtual/HallDialogService.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Constant.ts', './UIHelper.ts', './MKExport.ts', './NGame.ts', './GameDataMgr.ts', './PwaGuideDialog.ts', './PayUtils.ts', './Utils.ts', './CheckinAct.ts', './Turntable.ts', './DailyFirstRechargeDialog.ts', './FirstDepositLittle.ts', './PwaInstallHelper.ts'], function (exports) {
  var _asyncToGenerator, _regeneratorRuntime, cclegacy, tween, isValid, director, view, Node, UITransform, Vec3, BlockInputEvents, DialogType, RedDotType, EventName, UIHelper, UIPath, gloEvent, NGame, gameDataMgr, PwaGuideDialog, PayUtils, Utils, CheckinAct, Turntable, DailyFirstRechargeDialog, FirstDepositLittle, PwaInstallHelper;
  return {
    setters: [function (module) {
      _asyncToGenerator = module.asyncToGenerator;
      _regeneratorRuntime = module.regeneratorRuntime;
    ...
    execute: function () {
      ...
      var HallDialogService = exports('HallDialogService', /*#__PURE__*/function () {
        ...
        _proto.openPopViewList = function openPopViewList(index) {
          var _this = this;
          var id = this.popConf[index];
          if (id === undefined) {
            this.popConf = [];
          ...
          // let hallNode = GameGlobal.layerMgr.getNodeByTag(UITag.HallPage)
          // if (!isValid(hallNode)) {
          //     this.popConf = [];
          //     this.removeTouchMask();
          //     return
          ...
          // const hall = hallNode.getComponent("HallPage");
          // if (!hall) {
          //     this.removeTouchMask();
          //     return;
          // }
          ...
          switch (id) {
            case DialogType.DIALOG_TYPE_DAILY_SIGN:
              UIHelper.openUI(CheckinAct, UIPath.CheckinAct, undefined, dialogParams);
              break;
            case DialogType.DIALOG_TYPE_FIRST_TOP_UP:
              // 首充弹框
              UIHelper.openUI(FirstDepositLittle, UIPath.FirstDepositLittle, undefined, dialogParams);
              break;
            case DialogType.DIALOG_TYPE_WHEEL_ACTIVITY:
              UIHelper.openUI(Turntable, UIPath.Turntable, undefined, dialogParams);
              break;
            case DialogType.DIALOG_TYPE_DAILY_FIRST_DEPOSIT:
              UIHelper.openUI(DailyFirstRechargeDialog, UIPath.DailyFirstRechargeDialog, undefined, dialogParams);
              break;
            case DialogType.DIALOG_TYPE_PWA_GUIDE:
              UIHelper.openUI(PwaGuideDialog, UIPath.PwaGuideDialog, undefined, dialogParams);
              break;
            default:
        ...
        function () {
          var _initPlayerDayNormalLoginConfBySort = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
            ...
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                ...
                case 3:
                  needShowPwaGuide = _context2.sent;
                  ...
                  addPwaGuideFunc = function addPwaGuideFunc() {
                    if (needShowPwaGuide) {
                      conf.push(DialogType.DIALOG_TYPE_PWA_GUIDE);
                    }
                  }; // 剩余转盘次数
...
System.register("chunks:///_virtual/PayTypeItem.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Decorators.ts', './MKStaticViewBase.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, instantiate, Tween, UIOpacity, tween, Toggle, inject, MKStaticViewBase;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var PayTypeItem = exports('PayTypeItem', (_dec = ccclass('PayTypeItem'), _dec2 = inject("type_item", Node), _dec3 = inject("channelListView", Node), _dec4 = inject("channelItem", Node), _dec(_class = (_class2 = /*#__PURE__*/function (_MKStaticViewBase) {
        ...
        _proto.onNoSelect = function onNoSelect() {
          ...
          Tween.stopAllByTarget(this.typeItem.child("selImg"));
          this.typeItem.child("selImg").active = false;
          this.typeItem.child("selImg").getComponent(UIOpacity).opacity = 0;
          this.channelListView.active = false;
        ...
        _proto.onSelected = function onSelected(selChannelIdx) {
          ...
          this.typeItem.child("selImg").active = true;
          tween(this.typeItem.child("selImg").getComponent(UIOpacity)).to(0.3, {
            opacity: 255
          }).bindNodeState(false).start();
          if (this.channelListView.children.length > 0) {
            this.channelListView.active = true;
            this.updateChannelState(selChannelIdx, true);
            // this.channelListView.children.forEach((channelItem, idx) => {
            //     channelItem.child(`selBg`).active = idx == curSelIdx
            //     channelItem.child(`Toggle`).getComponent(Toggle).isChecked = idx == curSelIdx
            //     tween(channelItem.getComponent(UIOpacity))
            //         .to(0.5, { opacity: 255 })
            //         .bindNodeState(false)
            //         .start()
        ...
        _proto.updateChannelState = function updateChannelState(selChannelIdx, showAnim) {
          ...
          this.channelListView.children.forEach(function (channelItem, idx) {
            channelItem.child("selBg").active = idx == selChannelIdx;
            channelItem.child("Toggle").getComponent(Toggle).isChecked = idx == selChannelIdx;
            if (showAnim) {
              tween(channelItem.getComponent(UIOpacity)).to(0.5, {
                opacity: 255
              }).bindNodeState(false).start();
            }
          });
...
System.register("chunks:///_virtual/PayTypePage.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './GameCfg.ts', './Constant.ts', './UIHelper.ts', './MKViewBase.ts', './NGame.ts', './GameDataMgr.ts', './GamePermanent.ts', './UIController.ts', './HttpPbFunc.ts', './Utils.ts', './HowToPayDialog.ts', './PayTypeItem.ts', './GoogleAnatytics.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, instantiate, sys, GameCfg, EventName, UIHelper, UIPath, MKViewBase, NGame, gameDataMgr, gamePermanent, UIController, HttpPbFunc, isResponseValid, Utils, HowToPayDialog, PayTypeItem, GoogleAnalytics, GAEvent;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var PayTypePage = exports('default', (_dec = ccclass('PayTypePage'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_MKViewBase) {
        ...
        _proto.clickPay = function clickPay() {
          ...
          NGame.loading.show();
          var newWindow = null;
          if (GameCfg.isRelease && sys.isBrowser) {
  ...
  return {
    ...
    execute: function () {
      ...
      var PlayPage = exports('PlayPage', (_dec = ccclass('PlayPage'), _dec2 = inject("btnCashPool", Node), _dec3 = inject("root/ScrollView", Node), _dec4 = inject("root/node_top/node_right/btn_recharge", Node), _dec5 = inject("root/node_top/node_right/btn_fresh", Node), _dec6 = inject("root/node_top/node_head/mask_head", Node), _dec7 = inject("root/node_top/node_right/btn_setting", Node), _dec8 = inject("root/node_top/node_right/btn_email", Node), _dec9 = inject("root/node_top/layout_money/label_money", Node), _dec10 = inject("root/node_top/node_head/node_vip/label_vip", Node), _dec11 = inject("root/node_top/node_head/node_vip/icon_vip", Node), _dec12 = inject("root/node_top/node_head/mask_head/img_head", Node), _dec13 = inject("root/node_top/layout_bonus/label_bonus", Node), _dec14 = inject("root/node_top/debugOffsetDay", Node), _dec15 = inject("TopMoneyUi", Node), _dec16 = inject("root/node_top/test_Button", Node), _dec17 = inject("btnReload", Node), _dec18 = inject("root/ScrollView/view/content/TopBonusView", Node), _dec19 = inject("root/ScrollView/view/content/withdrawalNode", Node), _dec20 = inject("root/ScrollView/view/content/withdrawalNode/node_free_balance", Node), _dec21 = inject("root/ScrollView/view/content/withdrawalNode/node_cas_balance", Node), _dec22 = inject("root/ScrollView/view/content/tagBox", Node), _dec23 = inject("root/ScrollView/view/content/gameList", Node), _dec24 = inject("GameBaseItem", Node), _dec25 = inject("root", Node), _dec26 = inject("imgNoGame", Node), _dec27 = inject("root/node_top/bg_cur_currency", Node), _dec28 = inject("root/node_top/bg_cur_currency/btn_switch", Node), _dec29 = inject("gameBaseIcon", Sprite), _dec30 = inject("floatingTagNode", Node), _dec31 = inject("root/InstallBanner", Node), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseTabPage) {
        ...
        //     this.gameDataList = []
        //     this.allChildrenNodes.tagcontent.destroyAllChildren();
        //     // this.allChildrenNodes.gameList.destroyAllChildren();
        //     this.gameItemPool.clear();
        //     gameDataMgr.gameListData.pbfixGames.forEach(game => {
        //         NGame.asset.releaseRemoteCache(game.pbfixIcon)
        //     })
        //     gameDataMgr.gameListData.pbfixCategories.forEach(cat => {
        //         NGame.asset.releaseRemoteCache(cat.pbfixIcon)
        //     })
        //     this.scheduleOnce(() => {
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                ...
                case 2:
                  ...
                  break;
                case 6:
                  this.scrollView.getComponent(UITransform).height -= this.node.getChildByPath("root/node_top").contentSize().height;
...
System.register("chunks:///_virtual/WidInfo.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './GameCfg.ts', './Constant.ts', './Decorators.ts', './MKStaticViewBase.ts', './NGame.ts', './GameDataMgr.ts', './HttpPbFunc.ts', './WebApiEnums.ts', './GoogleAnatytics.ts', './PayUtils.ts', './Utils.ts', './WidAccountInfoView.ts', './FirstDeposit.ts', './PayTypeItem.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, Node, EditBox, instantiate, GameCfg, RATE_FEE, RATE_CURRENCY, inject, MKStaticViewBase, NGame, gameDataMgr, HttpPbFunc, isResponseValid, pbfixMoneyType, GoogleAnalytics, GAEvent, PayUtils, safetyNum, Utils, WidAccountInfoView, FirstDeposit, PayTypeItem;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
