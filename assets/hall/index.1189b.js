...
System.register("chunks:///_virtual/FreeBonusWithdraw.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './GloTitleBar.ts', './Constant.ts', './Decorators.ts', './UIHelper.ts', './MKViewBase.ts', './NGame.ts', './GameDataMgr.ts', './UIController.ts', './HttpPbFunc.ts', './WebApiEnums.ts', './GoogleAnatytics.ts', './Utils.ts', './PayTypeItem.ts', './CantWithdrawToRecharge.ts', './NeedMorePlay.ts', './WidAccountInfoView.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, Node, instantiate, GloTitleBar, EventName, inject, UIHelper, UIPath, MKViewBase, NGame, gameDataMgr, UIController, HttpPbFunc, isResponseValid, pbfixMoneyType, GAEvent, GoogleAnalytics, GAParamKey, Utils, safetyNum, PayTypeItem, CantWithdrawToRecharge, NeedMorePlay, WidAccountInfoView;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var Hall = exports('default', (_dec = ccclass('Hall'), _dec2 = inject("node_bottom/layout_btn", Node), _dec3 = inject("node_childPage", Node), _dec4 = inject("btn_service", Node), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseEntryView) {
        ...
        _proto.open = function open() {
          ...
          // 判断是否有token，没有跳过
          if (!gameDataMgr.gameBaseData.token) {
            return;
          }

          // 获取最后一次token续期时间戳
          var lastRefreshTime = NGame.storage.getNumber(StorageKey.LAST_TOKEN_REFRESH_TIME, 0);
          if ((Date.now() - lastRefreshTime) / 1000 >= GameCfg.TOKEN_REFRESH_INTERVAL) {
            // 需要重新续期
            this.startRefreshTokenSchedule();
          } else {
            try {
              // 还未到需要续期时间，需要延时续期时间，计算距离需要续期时间的时间差
              var refreshTokenTime = lastRefreshTime + GameCfg.TOKEN_REFRESH_INTERVAL * 1000;
              var diffTime = (refreshTokenTime - Date.now()) / 1000;
              if (diffTime <= 0) {
                diffTime = 1.0;
              }
              this.scheduleOnce(function () {
                _this2.startRefreshTokenSchedule();
              }, diffTime);
            } catch (error) {}
          }
        };
        _proto.initEvent = function initEvent() {
          ...
          this.onMsg(EventName.SWITCH_TAB, function (tabData) {
            _this3.switchPage(tabData.tabIndex, tabData.action);
          });
        };
                    ...
                    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                      while (1) switch (_context2.prev = _context2.next) {
                        ...
                        case 5:
                          ...
                          _context2.next = 8;
                          return NGame.uiManage.openHomeTab(_this4.pageList[index].page);
                        case 8:
                          page = _context2.sent;
                        case 9:
        ...
        _proto.startRefreshTokenSchedule = function startRefreshTokenSchedule() {
          this.unscheduleRefreshTokenReq();
        ...
        _proto.refreshTokenReq = function refreshTokenReq() {
          ...
          NGame.storage.set(StorageKey.LAST_TOKEN_REFRESH_TIME, Date.now());
        };
        _proto.onDestroy = function onDestroy() {
        ...
        _proto.unscheduleRefreshTokenReq = function unscheduleRefreshTokenReq() {
        ...
        _proto.regisUI = function regisUI() {
          ...
          NGame.uiManage.getRegisDataFunc = function (page) {
            ...
            if (page === PageSkLoading) {
              registData.source = "db://assets/resources/prefab/PageSkLoading.prefab";
            }
            return registData;
            // return {
      ...
      var HallDialogService = exports('HallDialogService', /*#__PURE__*/function () {
        ...
        _proto.openPopViewList = /*#__PURE__*/function () {
          var _openPopViewList = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(index) {
            var _this = this;
            var id, nextCallBack, dialogParams, pageKey, uiPath;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                ...
                case 5:
                  ...
                  _context2.t0 = id;
                  _context2.next = _context2.t0 === DialogType.DIALOG_TYPE_DAILY_SIGN ? 10 : _context2.t0 === DialogType.DIALOG_TYPE_FIRST_TOP_UP ? 13 : _context2.t0 === DialogType.DIALOG_TYPE_WHEEL_ACTIVITY ? 16 : _context2.t0 === DialogType.DIALOG_TYPE_DAILY_FIRST_DEPOSIT ? 19 : _context2.t0 === DialogType.DIALOG_TYPE_PWA_GUIDE ? 22 : 25;
                  break;
                case 10:
                  pageKey = CheckinAct;
                  uiPath = UIPath.CheckinAct;
                  return _context2.abrupt("break", 30);
                case 13:
                  // 首充弹框
                  pageKey = FirstDepositLittle;
                  uiPath = UIPath.FirstDepositLittle;
                  return _context2.abrupt("break", 30);
                case 16:
                  pageKey = Turntable;
                  uiPath = UIPath.Turntable;
                  return _context2.abrupt("break", 30);
                case 19:
                  pageKey = DailyFirstRechargeDialog;
                  uiPath = UIPath.DailyFirstRechargeDialog;
                  return _context2.abrupt("break", 30);
                case 22:
                  pageKey = PwaGuideDialog;
                  uiPath = UIPath.PwaGuideDialog;
                  return _context2.abrupt("break", 30);
                case 25:
                  pageKey = null;
                  uiPath = null;
                  ...
                  return _context2.abrupt("break", 30);
                case 30:
                  if (!(pageKey && uiPath && uiPath.length > 0)) {
                    _context2.next = 37;
                    break;
                  }
                  if (NGame.uiManage.isCache(pageKey)) {
                    _context2.next = 34;
                    break;
                  }
                  _context2.next = 34;
                ...
                case 34:
                  _context2.next = 36;
                  return UIHelper.openUI(pageKey, uiPath, undefined, dialogParams);
                case 36:
        ...
        _proto.checkShowGuideWidDialog = function checkShowGuideWidDialog() {
          ...
          if (userInfo) {
            if (PayUtils.hasRecharge) {
              ...
              // const widInfoIsVaild = NGame.storage.get(StorageKey.CASH_WITHDRWA_INFO_VAILD);
              ...
              show = userInfo.pbfixRemainValueBalance <= 0;
              openTag = "Cash";
            } else {
              // 没充值过，判断是否引导Bonus提现
              ...
              if (hallConf) {
                ...
                // const widInfoIsVaild = NGame.storage.get(StorageKey.FREE_BONUS_WITHDRWA_INFO_VAILD);
                // `NoRecharge -> bonusIsStandard = ${bonusIsStandard}, widInfoIsVaild = ${widInfoIsVaild}`.logI(`ujbd7993t71`)
                // show = bonusIsStandard && !widInfoIsVaild
                show = bonusIsStandard;
                openTag = "FreeBonus";
              }
            }
          }
...
System.register("chunks:///_virtual/PayTypePage.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './GameCfg.ts', './Constant.ts', './UIHelper.ts', './MKViewBase.ts', './NGame.ts', './GameDataMgr.ts', './GamePermanent.ts', './UIController.ts', './HttpPbFunc.ts', './PwaInstallHelper.ts', './GoogleAnatytics.ts', './PlatformUtils.ts', './Utils.ts', './HowToPayDialog.ts', './PayTypeItem.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, instantiate, sys, GameCfg, EventName, UIHelper, UIPath, MKViewBase, NGame, gameDataMgr, gamePermanent, UIController, HttpPbFunc, isResponseValid, PwaInstallHelper, GoogleAnalytics, GAEvent, PlatformUtils, Utils, HowToPayDialog, PayTypeItem;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
  ...
  return {
    ...
    execute: function () {
      ...
      var PlayPage = exports('PlayPage', (_dec = ccclass('PlayPage'), _dec2 = inject("btnCashPool", Node), _dec3 = inject("root/ScrollView", Node), _dec4 = inject("root/node_top/node_right/btn_recharge", Node), _dec5 = inject("root/node_top/node_right/btn_fresh", Node), _dec6 = inject("root/node_top/node_head/mask_head", Node), _dec7 = inject("root/node_top/node_right/btn_setting", Node), _dec8 = inject("root/node_top/node_right/btn_email", Node), _dec9 = inject("root/node_top/layout_money/label_money", Node), _dec10 = inject("root/node_top/node_head/node_vip/label_vip", Node), _dec11 = inject("root/node_top/node_head/node_vip/icon_vip", Node), _dec12 = inject("root/node_top/node_head/mask_head/img_head", Node), _dec13 = inject("root/node_top/layout_bonus/label_bonus", Node), _dec14 = inject("root/node_top/debugOffsetDay", Node), _dec15 = inject("TopMoneyUi", Node), _dec16 = inject("root/node_top/test_Button", Node), _dec17 = inject("btnReload", Node), _dec18 = inject("root/ScrollView/view/content/TopBonusView", Node), _dec19 = inject("root/ScrollView/view/content/withdrawalNode", Node), _dec20 = inject("root/ScrollView/view/content/withdrawalNode/node_free_balance", Node), _dec21 = inject("root/ScrollView/view/content/withdrawalNode/node_cas_balance", Node), _dec22 = inject("root/ScrollView/view/content/tagBox", Node), _dec23 = inject("root/ScrollView/view/content/gameList", Node), _dec24 = inject("GameBaseItem", Node), _dec25 = inject("root", Node), _dec26 = inject("imgNoGame", Node), _dec27 = inject("root/node_top/bg_cur_currency", Node), _dec28 = inject("root/node_top/bg_cur_currency/btn_switch", Node), _dec29 = inject("gameBaseIcon", Sprite), _dec30 = inject("floatingTagNode", Node), _dec31 = inject("root/InstallBanner", Node), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseTabPage) {
          ...
          var _setInstallBanner = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return PwaInstallHelper.warmup();
                case 2:
                  _context.next = 4;
                  return PwaInstallHelper.needShowInstallBanner();
                case 4:
                  needShowBanner = _context.sent;
                  if (needShowBanner) {
                    this.scheduleOnce(function () {
        ...
        _proto.resolveNeedShowInstallBanner = /*#__PURE__*/function () {
          var _resolveNeedShowInstallBanner = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
            var retryDelays, i;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                ...
                case 10:
                  ...
                  _context2.next = 14;
                  return this.waitInstallBannerRetry(retryDelays[i]);
                case 14:
                  _context2.prev = 14;
                  _context2.next = 17;
                  return PwaInstallHelper.needShowInstallBanner();
            ...
            }, _callee2, this, [[0, 5], [14, 21]]);
          }));
          function resolveNeedShowInstallBanner() {
            return _resolveNeedShowInstallBanner.apply(this, arguments);
          }
          return resolveNeedShowInstallBanner;
        }();
        _proto.waitInstallBannerRetry = function waitInstallBannerRetry(delaySeconds) {
          var _this4 = this;
        ...
        _proto.setFloatingTagNodePos = function setFloatingTagNodePos(delay) {
          ...
          this.scheduleOnce(function () {
            var posY = _this5.node.getChildByPath("root/node_top").pos(PosType.BOTTOM_WORLD).y - _this5.floatingTagNode.contentSize().height / 2;
            _this5.floatingTagNode.worldPosition = v3(_this5.floatingTagNode.worldPosition.x, posY);
            _this5.refreshFloatingTagThreshold();
            _this5.queueFloatingTagStateUpdate();
          }, delay);
        };
        _proto.onEnable = function onEnable() {
          // 每次页面切回来都需要重置位置
        ...
        _proto.open = function open() {
          ...
          this.onMsg(EventName.ON_ACT_LIST_UPDATE, function () {
            if (_this6.node.active) {
              _this6.initTopActivityList();
            }
          });
          this.onMsg(EventName.ON_GET_USER_INFO, function () {
            // this.initTopActivityList();
            // this.refreshListView();
            _this6.setBtnRecharge();
            _this6.updateUserInfo();
            _this6.initWithdrawlView();
            _this6.updateReddotByUserInfoData();
          });
          this.onMsg(EventName.REQUEST_TO_REQ_USER_INFO, function (mData) {
            HttpPbFunc.pbfixUserInfoReq(null, (mData == null ? void 0 : mData.needRefreshBalance) || false, function (data) {
              if (mData != null && mData.isCloseGamePage || false) {
                HallDialogService.getInstance().checkShowGuideWidDialog();
              }
            });
          });
          this.onMsg(EventName.ON_OPEN_WEB_GAME, function () {
            _this6.initGameCategoryList();
            _this6.updateGameList();
          });
          this.onMsg(EventName.SWITICH_CURRENCY_BY_DIALOG, function () {
            _this6.updateWithdViewVisible();
          });
          ...
          this.onClicked(this.btnSwitchCurrency, function () {
            ...
            _this6.bgCurCurrency.getComponent(CurrencySwitcher).onSwitchClick();
          }, false, 0.5);
        ...
        _proto.preloadPage = /*#__PURE__*/function () {
          var _preloadPage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
            var preloadTasks;
            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
        ...
        _proto.createFloatingTagNodeOptimized = function createFloatingTagNodeOptimized() {
          ...
          newTagCatNode.getChildByPath("taglists/view/tagcontent").children.forEach(function (tagItem, idx) {
            ...
            if (tagNodeName == _this7.TAG_CAT_ITEM_NAME_ALL) {
              tagItem.child("inner").child("ic").loadImg("page_play/img/Group 59134", BundleName.HALL, _this7);
            } else if (tagNodeName == _this7.TAG_CAT_ITEM_NAME_HISTORY) {
              tagItem.child("inner").child("ic").loadImg("page_play/img/clock", BundleName.HALL, _this7);
            } else if (tagNodeName == _this7.TAG_CAT_ITEM_NAME_LOVE) {
              tagItem.child("inner").child("ic").loadImg("page_play/img/hear3", BundleName.HALL, _this7);
            } else if (_this7.normalGameCatList[idx]) {
              _this7.setTagIcon(tagItem, _this7.normalGameCatList[idx]);
            }
          });
          newTagCatNode.getChildByPath("taglists/view/tagcontent").children.forEach(function (item, idx) {
            _this7.onClicked(item, function () {
              // this.scrollView.scrollToIndex(2);
              _this7.onClickGameCategoryItem(idx);
            });
          });
        };
        ...
        _proto.runIconPrewarmWorker = function runIconPrewarmWorker(iconUrls, token) {
          ...
          GameBaseItem.preloadIcon(iconUrl, this.node)["finally"](function () {
            if (token !== _this8.iconPrewarmToken || !_this8.node || !_this8.node.isValid) {
              return;
            }
            _this8.scheduleOnce(function () {
              _this8.runIconPrewarmWorker(iconUrls, token);
            }, 0.02);
          });
        }
        ...
        _proto.setBtnRecharge = function setBtnRecharge() {
          ...
          this.onClicked(btnRecharge, function () {
            ...
            _this9.topMoneyUi.getComponent(TopMoneyUi).openView(function () {
              bonusAniNode.active = !PayUtils.isFirstPayActBuyed;
              if (bonusAniNode.active) {
                var _this9$ttTween;
                (_this9$ttTween = _this9.ttTween) == null || _this9$ttTween.start();
              }
            });
            (_this9$ttTween2 = _this9.ttTween) == null || _this9$ttTween2.stop();
        ...
        _proto.setBtnUpdateUserInfo = function setBtnUpdateUserInfo() {
          ...
          this.onClicked(this.freshBtn, function () {
            var _this10$icRefreshTwee, _this10$icRefreshTwee2;
            // `onClicked`.logI(`9uasb9uasbubu9o`)
            _this10.offClicked(_this10.freshBtn);
            // const icRefresh = this.freshBtn.child(`icRefresh`);
            if (!_this10.icRefreshTween) {
              _this10.icRefreshTween = tween(_this10.freshBtn).set({
                angle: 0
              }).to(1, {
                angle: -720
              }).union().repeatForever().bindNodeState(false);
            }
            (_this10$icRefreshTwee = _this10.icRefreshTween) == null || _this10$icRefreshTwee.stop();
            (_this10$icRefreshTwee2 = _this10.icRefreshTween) == null || _this10$icRefreshTwee2.start();
            var actionTiem = Date.now();
            HttpPbFunc.pbfixUserInfoReq(_this10.node, false, function () {
              var delay = 0;
              ...
              _this10.scheduleOnce(function () {
                var _this10$icRefreshTwee3;
                (_this10$icRefreshTwee3 = _this10.icRefreshTween) == null || _this10$icRefreshTwee3.stop();
                _this10.setBtnUpdateUserInfo();
              }, delay / 1000);
            });
          });
        };
        ...
        _proto.initTopActivityList = function initTopActivityList() {
          ...
          var _loop = function _loop() {
            ...
            item.active = true;
            _this11.topBonusView.getComponent(PageView).addPage(item);
            item.getComponent(BannerView).setData(data, false);
            _this11.onClicked(item, function () {
          ...
          tween(this.topBonusView).delay(6).call(function () {
            var index = _this11.topBonusView.getComponent(PageView).getCurrentPageIndex();
            if (index == _this11.topBonusView.getComponent(PageView).getPages().length - 1) {
              index = 0;
            } else {
              index++;
            }
            _this11.topBonusView.getComponent(PageView).scrollToPage(index, 0.3);
        ...
        _proto.onClickLoveBtn = /*#__PURE__*/function () {
          var _onClickLoveBtn = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(gameId, actionAddToCollect) {
        ...
        _proto.initGameCategoryList = function initGameCategoryList() {
          ...
          var _loop2 = function _loop2(index) {
            var cat = _this12.normalGameCatList[index];
            if (_this12.gameCategoryNodes.length != _this12.newTagLen) {
              var _item3 = instantiate(tagbase);
              _item3.parent = tagcontent;
              _item3.active = true;
              _item3.name = cat.pbfixId + "";
              _this12.setTagIcon(_item3, cat);
              _this12.gameCategoryNodes.push(_item3);
              _this12.onClicked(_item3, function () {
                _this12.onClickGameCategoryItem(index);
              });
            }
          };
          ...
          if (this.hotList.length > 0) {
            ...
            if (this.gameCategoryNodes.length != this.newTagLen) {
              ...
              this.onClicked(item, function () {
                _this12.onClickGameCategoryItem(_tt);
              });
            }
          }
          if (this.historyList.length > 0) {
            ...
            if (this.gameCategoryNodes.length != this.newTagLen) {
              ...
              this.onClicked(_item, function () {
                _this12.onClickGameCategoryItem(_tt2);
              });
            }
          }
          ...
          if (this.gameCategoryNodes.length != this.newTagLen) {
            ...
            this.onClicked(_item2, function () {
              _this12.onClickGameCategoryItem(tt);
            });
          }
          // }

          this.scheduleOnce(function () {
            _this12.setCatItemState();
            _this12.rebuildFloatingTagNodeOptimized();
            _this12.refreshFloatingTagThreshold();
            _this12.queueFloatingTagStateUpdate();
          });
        ...
        function () {
          var _onClickGameSearchBtn = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
            var gameSearch;
        ...
        function () {
          var _setTagIcon = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(item, element) {
            var _this13 = this;
        ...
        _proto.updateGameList = function updateGameList(gameSearchStr, isActionLoved) {
          ...
          if (gameList) {
            ...
            gameList.forEach(function (gameData) {
              var gameItem = _this14.createGameItem();
              gameItem.active = true;
              _this14.gameList.addChild(gameItem);
              gameItem.getComponent(GameBaseItem).onClickLoveFunc = _this14._onClickLoveHandler;
              gameItem.getComponent(GameBaseItem).showIconData(gameData, _this14.gameBaseIcon.spriteFrame, _this14.collectGameIdSet.has(gameData.pbfixId));
            });
            this.prewarmCurrentCategoryIcons();
            this.scheduleOnce(function () {
              _this14.onMainScrollViewScrolling();
            }, 0.1);
        ...
        _proto.reqRedDotList = function reqRedDotList() {
          ...
          HttpPbFunc.pbfixRedDotListReq(this.node, function (result) {
            _this15.updateRedDotStatus(result);
            NGame.loading.hide();
...
System.register("chunks:///_virtual/WidInfo.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './GameCfg.ts', './Constant.ts', './Decorators.ts', './MKStaticViewBase.ts', './NGame.ts', './GameDataMgr.ts', './HttpPbFunc.ts', './WebApiEnums.ts', './GoogleAnatytics.ts', './PayUtils.ts', './Utils.ts', './WidAccountInfoView.ts', './FirstDeposit.ts', './PayTypeItem.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, Node, EditBox, instantiate, GameCfg, RATE_FEE, RATE_CURRENCY, inject, MKStaticViewBase, NGame, gameDataMgr, HttpPbFunc, isResponseValid, pbfixMoneyType, GAEvent, GoogleAnalytics, GAParamKey, PayUtils, safetyNum, Utils, WidAccountInfoView, FirstDeposit, PayTypeItem;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
