...
System.register("chunks:///_virtual/TestPage2.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseEntryView.ts', './Decorators.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _decorator, Node, Layout, Button, instantiate, Label, BaseEntryView, inject;
  return {
    setters: [function (module) {
    ...
    execute: function () {
      ...
      var TestPage2 = exports('default', (_dec = ccclass('TestPage2'), _dec2 = inject("btns/btnClose", Node), _dec3 = inject("btns/btnimg1", Node), _dec4 = inject("btns/btnimg2", Node), _dec5 = inject("imgsNode/img1", Node), _dec6 = inject("imgsNode/img2", Node), _dec7 = inject("btns", Layout), _dec8 = inject("btns/btn_tem", Button), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseEntryView) {
        ...
        function TestPage2() {
          ...
          _initializerDefineProperty(_this, "btnimg1", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "btnimg2", _descriptor3, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "img1", _descriptor4, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "img2", _descriptor5, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "btnsLayout", _descriptor6, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "temBtn", _descriptor7, _assertThisInitialized(_this));
          return _this;
        }
        ...
        _proto.open = function open() {
          // this.addBtn("CLOSE", this.closeAndDestroy.bind(this))
          // this.addBtn("Img1", async () => {
          //     // this.img1.getComponent(Sprite).spriteFrame = await NGame.asset.get(`test/img/rk`, SpriteFrame, this)
          //     this.img1.loadImg(`common/img/rk`, null, this.node)
          // })
          // this.addBtn("Img2", async () => {
          //     // const sf = await NGame.asset.get(`img/baoxiang`, SpriteFrame, this, { bundleStr: 'testBundle' })
          //     // this.img2.getComponent(Sprite).spriteFrame = await NGame.asset.get(`db://assets/testBundle/img/baoxiang`, SpriteFrame, this)
          //     // this.img2.loadImg(`img/baoxiang`, 'testBundle')
          //     this.img2.loadImg(
          //         {
          //             urls: `img/penguinImages`,
          //             key: `icon_jackpot`
          //         },
          //         'testBundle',
          //         this.node
          ...
          // this.addBtn("playMusic", this.playMusic.bind(this))
          // this.addBtn("stopMusic", this.stopMusic.bind(this))
          // this.addBtn("playTestBundleMusic", this.playTestBundleMusic.bind(this))

          // this.addBtn("playEffect", this.playEffect.bind(this))
          // this.addBtn("stopEffect", this.stopEffect.bind(this))
          // this.addBtn("playTestBundleEffect", this.playTestBundleEffect.bind(this))

          // this.onMsg(`xiaoxi`, (data: any) => {
          //     `msg aaaaa = ${JSON.stringify(data)}`.logI(`fdsbvdsfgsfgs`);
          // });

          // `bundle name = ${NGame.bundle.bundleStr}`.logI(LogTAG.TestTAG);
        }
        ...
        // private playMusic() {
        //     NGame.audio.playMusic(`common/audio/slot_maya_main_bgm`)
        // }

        // private stopMusic() {
        //     NGame.audio.music.stop()
        // }

        // private playTestBundleMusic() {
        //     NGame.audio.playMusic(`audio/slot_god_allplate_bgm`, `testBundle`)
        // }

        // private playEffect() {
        //     NGame.audio.playEffect(`common/audio/ddd`)
        // }
        // private stopEffect() {
        //     NGame.audio.effect.stop()
        // }
        // private playTestBundleEffect() {
        //     NGame.audio.playEffect(`audio/ddd_b`, `testBundle`)
        // }
        ;

        return TestPage2;
      }(BaseEntryView), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "btnClose", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "btnimg1", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "btnimg2", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "img1", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "img2", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "btnsLayout", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "temBtn", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
